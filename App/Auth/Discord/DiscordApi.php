...
class DiscordApi
{
    ...
    #[NoReturn] public static function login(): void
    {
        ...
        setcookie('discordState', $state, Sess::cookOpts(samesite: 'None'));
        $params = [
    ...
    public static function apiRequest($url, $post=FALSE, $headers=[]) {
        ...
        if(Api::session('access_token'))
            $headers[] = 'Authorization: Bearer ' . Api::session('access_token');
    ...
    {
        return "https://{$_SERVER['SERVER_NAME']}/auth/discord.php";
    }
}